...
- リリース設定と Terraform に実行基盤の選択項目を追加し、`cloud-run` または `cloud-batch` に応じて必要な API、ジョブリソース、IAM、制御側設定を構築する。
...
- Terraform の API 有効化、条件付きリソース、サービスアカウント、IAM、outputs／variables
